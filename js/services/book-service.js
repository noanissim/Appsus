...
function saveBookFromGoogle(book) {
...
function getGoogleBooks(title) {
    ...
    let url = `https://www.googleapis.com/books/v1/volumes?printType=books&q=${title}`
    return axios.get(url)
        .then(res => {
            ...
            savedSearchResults[title] = searchResults
            utilService.saveToStorage(SEARCH_KEY, savedSearchResults)
...
function _convertGoogleBook(googleBook) {
    ...
    book.thumbnail = "https://images-na.ssl-images-amazon.com/images/I/41OkNsUszFL._SX379_BO1,204,203,200_.jpg"
    book.listPrice = {
        "amount": 109,
        "currencyCode": "EUR",
        "isOnSale": false
